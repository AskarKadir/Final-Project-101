 ...
 */
package uaspws.askar.JpaController;
...
import uaspws.askar.exceptions.NonexistentEntityException;
import uaspws.askar.exceptions.PreexistingEntityException;
...
public class PendudukJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("uaspws_askar_jar_0.0.1-SNAPSHOTPU");
